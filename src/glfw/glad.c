/*
    ...
    OpenGL loader generated by glad 0.1.24a0 on Sat Jun  9 23:39:50 2018.
    ...
    Commandline:
        --profile="compatibility" --api="gl=3.0" --generator="c" --spec="gl" --no-loader --local-files --omit-khrplatform --extensions=""
    Online:
        http://glad.dav1d.de/#profile=compatibility&language=c&specification=gl&api=gl%3D3.0
*/
